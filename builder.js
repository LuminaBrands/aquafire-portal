...
// Cutout widths carry 3/8" of clearance in total — nominal + 3/8", split across
// the two outside edges — the install-crew recommendation. See the note above
// MODELS in app.js. Keep the two tables in step.
const MODELS = {
  original: {
