...
| `api/notify-slack.js` | **Vercel serverless function** that Slack-alerts Ember's dead ends (unanswered questions + human handoffs) to `#chat-insights-feeback`; zero npm deps; needs `SLACK_WEBHOOK_URL` env var in Vercel |
